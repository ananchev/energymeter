...
METERS = [
            dict(meter_id=10, 
                 mqtt_topic_total='energy/line0-total', 
                 mqtt_topic_last_hour='energy/line0-last-hour'),
            dict(meter_id=11, 
                 mqtt_topic_total='energy/line1-total', 
                 mqtt_topic_last_hour='energy/line1-last-hour'),
            dict(meter_id=2, 
                 mqtt_topic_total='energy/line2-total', 
                 mqtt_topic_last_hour='energy/line2-last-hour'),
            dict(meter_id=3, 
                 mqtt_topic_total='energy/line3-total', 
                 mqtt_topic_last_hour='energy/line3-last-hour'),
            dict(meter_id=4, 
                 mqtt_topic_total='energy/line4-total', 
                 mqtt_topic_last_hour='energy/line4-last-hour'),
            dict(meter_id=5, 
...
class ReaderPublisher():
    ...
    def total_energy_last_hour(self, meter, current_energy_reading):
        ...
        energy_reading_one_hour_ago = self.readings_1hr_ago.get(meter_id, 0) 
